...
export default function ApplyPage() {
  ...
  const jobTitle = new URLSearchParams(window.location.search).get('job') || 'Customer Support Representative';
  const totalSteps = 7;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#1a1f4a] via-[#1e2657] to-[#2a3570] relative overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center p-6">
        <div className="w-full max-w-3xl">
          ...
          {/* Main Content Card */}
          <div className="bg-white/5 backdrop-blur-lg rounded-2xl border border-white/10 p-8 md:p-12 shadow-2xl">
            {renderStep()}
